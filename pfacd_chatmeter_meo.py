...
with open('style.css') as f:
    st.markdown(f'''<style>{f.read()}
                    /* Alterar a cor do slider | Fontes: https://discuss.streamlit.io/t/how-to-change-st-sidebar-slider-default-color/3900/2 
                                                         https://discuss.streamlit.io/t/customizing-the-appearance-of-tabs/48913 */
                    div.stSlider > div[data-baseweb="slider"] > div > div > div[role="slider"]{{
                        background-color: #3297a3;
                    }}
...
Facebook_PCU_Analysis = Facebook_PCU_Analysis[Facebook_PCU_Analysis['page'] == 'MEO']
Facebook_Posts_Analysis = Facebook_Posts_Analysis[Facebook_Posts_Analysis['page'] == 'MEO']
...
def apply_filters(filters=None):
    ...
    # Filtro por Posts que incluem 'MEO' - Post e PCU
    if filters['post_MEO_filter']:
        filtered_Post_df = filtered_Post_df[filtered_Post_df['post_text_MEO'] == 1]
        filtered_PCU_df = filtered_PCU_df[filtered_PCU_df['post_text_MEO'] == 1]

    # Filtro por Comentários que incluem 'MEO' - PCU
    if filters['comment_MEO_filter']:
        filtered_PCU_df = filtered_PCU_df[filtered_PCU_df['comment_text_MEO'] == 1]
...
with col3_F:
    # Filtro por Posts que incluem 'MEO'
    post_MEO_filter = st.checkbox("Apenas Posts que Incluem **MEO**", value=False)

    # Filtro por Comentários que incluem 'MEO'
    comment_MEO_filter = st.checkbox("Apenas Comentários que Incluem **MEO**", value=False)
...
if st.button("Filtrar", on_click=click_button, key='filtros_button'):
    Facebook_PCU_Analysis, Facebook_Posts_Analysis = apply_filters({
        ...
        'end_date': end_date,
        'post_MEO_filter': post_MEO_filter,
        'comment_MEO_filter': comment_MEO_filter,
        'n_reacts': n_reacts,
...
pfacd_functions.create_card(col1, "fas fa-newspaper", (0, 100, 112), (255, 255, 255),
                            "Total de Posts", Facebook_PCU_Analysis['post_id'].nunique())

# Cartão 2 | Total de Comentários
pfacd_functions.create_card(col2, "fas fa-comments", (50, 151, 163), (255, 255, 255),
                            "Total de Comentários", Facebook_PCU_Analysis['comment_id'].nunique())

# Cartão 3 | Total de Utilizadores Únicos
pfacd_functions.create_card(col3, "fas fa-users", (153, 203, 209), (255, 255, 255),
...
try:
    ...
    with tab1:
        ...
        fig_plot_line.update_traces(line_color='#006470', line_width=1)
        ...
        with col2_P:
            ...
            posts_per_weekday_df = pd.DataFrame({
                'n': posts_per_weekday['MEO'],
                '%': posts_per_weekday_percent['MEO']
            })
            st.markdown("<br><br>", unsafe_allow_html=True)
        ...
        with col1_P:
            ...
            pfacd_functions.create_card(col1_T, "fas fa-newspaper", (0, 100, 112), (255, 255, 255),
            ...
            pfacd_functions.create_card(col2_T, "fas fa-newspaper", (50, 151, 163), (255, 255, 255),
            ...
            pfacd_functions.create_card(col3_T, "fas fa-newspaper", (153, 203, 209), (255, 255, 255),
        ...
        fig_plot_bar = px.bar(posts_per_CR_label, x='CR Label', y='Total de Posts',
                              ...
                              color='CR Label',
                              color_discrete_map={'Carece de Resposta': palette_MEO[0], 'Não Carece de Resposta': palette_MEO[1]})
        ...
        posts_per_SRC_plot = px.area(
            ...
            color_discrete_sequence=palette_MEO
        )
    ...
    with tab2:
        ...
        fig_plot_line.update_traces(line_color='#3297a3', line_width=1)
        fig_plot_line.update_layout(
            xaxis_title='Data',
        ...
        with col1_C:
            ...
            pfacd_functions.create_card(col1_TC, "fas fa-comments", (0, 100, 112), (255, 255, 255),
            ...
            pfacd_functions.create_card(col2_TC, "fas fa-comments", (50, 151, 163), (255, 255, 255),
            ...
            pfacd_functions.create_card(col3_TC, "fas fa-comments", (153, 203, 209), (255, 255, 255),
        ...
        with col2_C:
            ...
            comments_per_weekday_df = pd.DataFrame({
                'n': comments_per_weekday['MEO'],
                '%': comments_per_weekday_percent['MEO']
            })
            st.markdown("<br><br>", unsafe_allow_html=True)
    ...
    with tab3:
        ...
        pfacd_functions.create_card(col2_U11, "fas fa-users", (0, 100, 112), (255, 255, 255),
        ...
        pfacd_functions.create_card(col2_U11, "fas fa-users", (50, 151, 163), (255, 255, 255),
        ...
        pfacd_functions.create_card(col2_U11, "fas fa-users", (153, 203, 209), (255, 255, 255),
